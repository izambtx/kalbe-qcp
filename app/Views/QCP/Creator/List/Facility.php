    ...
    <div class="card">
        ...
        <div class="row my-4 mx-3">
            <div class="col-auto mr-auto my-auto">
                <a href="/QCP/Facility/FormCreate" type="button" class="icon-btn add-btn">
            ...
            <div class="col-auto">
                <div class="input-wrapper">
                    <form action="" method="post">
                        ...
                        <input placeholder="search.." class="input-search" name="keyword" type="text" value="<?= $keyword; ?>">
                    </form>
                </div>
            </div>
        </div>
        <table class="table table-hover text-gray-900 text-center">
            <thead>
                <tr>
                    ...
                    <td class="font-weight-bold" scope="col">Bagian</td>
            ...
            <tbody>
                ...
                <?php foreach ($facility as $b) : ?>
                    <tr>
                        <td scope="row"><?= $i++; ?></td>
                        <td><?= $b['nama_project']; ?></td>
                        <td><?= $b['nama_distribusi']; ?></td>
                        ...
                        <td>
                            <a href="/QCP/Facility/Details/<?= $b['id']; ?>">
