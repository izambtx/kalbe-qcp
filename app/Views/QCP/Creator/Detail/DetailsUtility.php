...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card text-center shadow">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" rowspan="2" class="border border-light align-middle">
                                    <a href="/QCP/Utility/FormEdit/<?= $utility['id']; ?>" class="btn btn-lg btn-warning rounded-sm">update <i class="fas fa-arrow-alt-circle-right"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="border border-light border-left-0 align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="3">
                                ...
                                <br>
                                <small class="font-weight-bold text-success"><?= date('H : i : s', strtotime($utility['created_at'])); ?></small>
                                <br>
                                <br>
                            ...
                            <td rowspan="3">
                                ...
                                <?php if ($utility['status'] == 'Created' || $utility['status'] == 'Updated' || $utility['status'] == 'Returned' || $utility['status'] == 'Rejected') : ?>
                                    <br>
                                    <br>
                                    <br>
                                ...
                                <?php else : ?>
                                    ...
                                    <br>
                                    <small class="font-weight-bold text-success"><?= date('H : i : s', strtotime($utility['approved_at'])); ?></small>
                                    <br>
                                    <br>
        ...
        <?php if ($utility['status'] == 'Approved') : ?>
