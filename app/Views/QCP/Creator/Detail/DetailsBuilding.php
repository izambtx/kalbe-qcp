...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card text-center shadow">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" rowspan="2" class="border border-light align-middle">
                                    <a href="/QCP/Building/FormEdit/<?= $building['id']; ?>" class="btn btn-lg btn-warning rounded-sm">update <i class="fas fa-arrow-alt-circle-right"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="border border-light border-left-0 align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="3">
                                ...
                                <br>
                                <small class="font-weight-bold text-success"><?= date('H : i : s', strtotime($building['created_at'])); ?></small>
                                <br>
                                <br>
                            ...
                            <td rowspan="3">
                                ...
                                <?php if ($building['status'] == 'Created' || $building['status'] == 'Updated' || $building['status'] == 'Returned' || $building['status'] == 'Rejected') : ?>
                                    <br>
                                    <br>
                                    <br>
                                ...
                                <?php else : ?>
                                    ...
                                    <br>
                                    <small class="font-weight-bold text-success"><?= date('H : i : s', strtotime($building['approved_at'])); ?></small>
                                    <br>
                                    <br>
        ...
        <?php if ($building['status'] == 'Approved') : ?>
