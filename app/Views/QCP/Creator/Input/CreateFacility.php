...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card p-5">
        ...
        <div class="d-flex justify-content-between">
            <a href="<?= base_url('/QCP/Facility'); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; List QCP Facility</a>
            <h4 class="text-gray-900">Add New <span class="font-weight-bold">Project QCP Facility</span></h4>
        </div>
        ...
        <form class="mx-5 mt-2 mb-5 px-5 text-left" method="post" action="/QCP/Facility/SaveProject" enctype="multipart/form-data">
            <?php csrf_field(); ?>
