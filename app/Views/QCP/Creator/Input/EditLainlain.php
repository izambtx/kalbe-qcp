...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card p-5">
        ...
        <div class="d-flex justify-content-between">
            <a href="<?= base_url('/QCP/Lainlain/Details/' . $lainlain['id']); ?>" type="button" class="btn btn-outline-primary mb-5"><i class="fas fa-chevron-circle-left"></i>&nbsp; Detail QCP Lainlain</a>
            <h4 class="text-gray-900">Edit Returned <span class="font-weight-bold">Project QCP Lainlain</span></h4>
        </div>
        ...
        <form class="mx-5 mt-2 mb-5 px-5 text-left" method="post" action="/QCP/Lainlain/UpdateProject/<?= $lainlain['id']; ?>" enctype="multipart/form-data">
            <?php csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control rounded-sm <?php if (session('validation.nama')) : ?>is-invalid<?php endif ?>" id="nama" name="nama" value="<?= $lainlain['nama_project']; ?>" placeholder="Nama Project" autofocus>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control rounded-sm <?php if (session('validation.sasaran')) : ?>is-invalid<?php endif ?>" id="sasaran" name="sasaran" value="<?= $lainlain['sasaran_kpi']; ?>" placeholder="Sasaran KPI">
                <div class="invalid-feedback">
                ...
                <div class="input-group">
                    <select class="<?php if (session('validation.department')) : ?>is-invalid<?php endif ?> custom-select rounded-sm" id="department" name="department">
                        ...
                        <?php foreach ($department as $d) : ?>
                            <option value="<?= $d['id'];  ?>" <?= $lainlain['bagian'] == $d['id'] ? 'selected' : '' ?>><?= $d['nama_distribusi'];  ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        <input type="date" class="form-control rounded-sm <?php if (session('validation.start')) : ?>is-invalid<?php endif ?>" name="start" id="start" value="<?= date('Y-m-d', strtotime($lainlain['start'])); ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="col">
                        <input type="date" class="form-control rounded-sm <?php if (session('validation.end')) : ?>is-invalid<?php endif ?>" name="end" value="<?= date('Y-m-d', strtotime($lainlain['end'])); ?>">
                        <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-sm mt-3 <?php if (session('validation.sebelum')) : ?>is-invalid<?php endif ?>" name="sebelum" id="sebelum" rows="6" placeholder="Keterangan Sebelum Perbaikan"><?= $lainlain['sebelum']; ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-sm mt-3 <?php if (session('validation.solusi')) : ?>is-invalid<?php endif ?>" name="solusi" id="solusi" rows="5" placeholder="Keterangan Solusi Perbaikan"><?= $lainlain['solusi']; ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-sm <?php if (session('validation.sesudah')) : ?>is-invalid<?php endif ?>" name="sesudah" id="sesudah" rows="5" placeholder="Keterangan Setelah Perbaikan"><?= $lainlain['sesudah']; ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-sm <?php if (session('validation.hasil')) : ?>is-invalid<?php endif ?>" name="hasil" id="hasil" rows="5" placeholder="Keterangan Hasil terukur yang didapat dan dampak QCDSMPE"><?= $lainlain['hasil']; ?></textarea>
                <div class="invalid-feedback">
