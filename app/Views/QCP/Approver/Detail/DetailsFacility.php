                ...
                <tbody>
                    <tr>
                        ...
                        <td rowspan="3">
                            ...
                            <br>
                            <small class="font-weight-bold text-success"><?= date('H : i', strtotime($facility['created_at'])); ?></small>
                            <br>
                            <br>
                        ...
                        <td rowspan="3">
                            ...
                            <?php if ($facility['status'] == 'Created' || $facility['status'] == 'Updated') : ?>
                            ...
                            <?php elseif ($facility['status'] == 'Returned' || $facility['status'] == 'Rejected') : ?>
                                <br>
                                <br>
                                <br>
                            ...
                            <?php else : ?>
                                ...
                                <br>
                                <small class="font-weight-bold text-success"><?= date('H : i', strtotime($facility['approved_at'])); ?></small>
                                <br>
                                <br>
        ...
        <div class="modal-content rounded-md">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/QCP/Approver/Facility/ReturnProject/<?= $facility['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content rounded-md">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/QCP/Approver/Facility/RejectProject/<?= $facility['id']; ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="form-group row mb-0 mt-5">
        ...
        <div class="modal-content rounded-md">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/QCP/Approver/Facility/SaveProject/<?= $facility['id']; ?>" method="post">
                        <?= csrf_field();  ?>
                        <div class="form-group row mb-0 mt-5">
                            <label for="nama" class="col-sm-3 col-form-label">Nama Project </label>
                            <div class="col-sm-9">
                                <textarea readonly rows="4" id="nama" name="nama" class="form-control font-weight-bold text-gray-900 border-0 bg-white"><?= $facility['nama_project']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
                            <label for="nocpr" class="col-sm-3 col-form-label">CPR No. </label>
                            <div class="col-sm-9">
                                <input type="text" id="nocpr" name="nocpr" readonly value="QCP1-<?= $facility['singkatan']; ?>-<?= $facility['cpr_no']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                            </div>
                        </div>
                        <div class="form-group row mb-1">
                            <label for="cc" class="col-sm-4 col-form-label">Change Control </label>
                            <div class="col-sm-8">
                                <?php if (empty($facility['changecontrol'])) : ?>
                                    <input type="text" id="cc" name="cc" value="<?= $facility['changecontrol']; ?>" class="form-control font-weight-bold text-gray-900"></input>
                                <?php else : ?>
                                    <input type="text" id="cc" name="cc" readonly value="<?= $facility['changecontrol']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
