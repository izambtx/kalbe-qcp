                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="col" class="align-middle border-light border-left border-top-0 py-1">
                            <?php if (empty($utility['approved_at']) || empty($utility['penyetuju'])) : ?>
                            <?php else : ?>
                                <?= $utility['cpr_no']; ?>
                            <?php endif; ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td scope="col" class="align-middle border-light border-bottom border-left py-1">
                            <?= date('F', strtotime($utility['created_at'])); ?>
                        </td>
                        ...
                        <td scope="col" class="align-middle border-light border-bottom border-left py-1">
                            <?php foreach ($kategori as $k) : ?>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" <?php if ($k['id'] == 3) : ?>checked<?php else : ?>disabled<?php endif ?> class="custom-control-input" id="<?= $k['id']; ?>">
                    ...
                    <tr>
                        ...
                        <td scope="col" class="align-middle border-light border-bottom border-left py-1">
                            <?= date('F Y', strtotime($utility['start'])); ?>
                        </td>
                        <td scope="col" class="align-middle border-light border-bottom border-left font-weight-bold py-1">
                            End Project
                        </td>
                        <td scope="col" class="align-middle border-light border-bottom border-left py-1">
                            <?= date('F Y', strtotime($utility['end'])); ?>
                        </td>
                    </tr>
                </tbody>
                <?php if ($utility['status'] == 'Returned' || $utility['status'] == 'Rejected') : ?>
                    <tfoot>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="border border-light align-middle">
                                <?php if ($utility['status'] == 'Returned') : ?>
                                    <?= date('d F Y', strtotime($utility['returned_at'])); ?>
                                <?php elseif ($utility['status'] == 'Rejected') : ?>
                                    <?= date('d F Y', strtotime($utility['rejected_at'])); ?>
                                <?php endif; ?>
                            </td>
                        </tr>
                    </tfoot>
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="2" rowspan="3" class="w-50 text-left">
                            ...
                            <span class=" text-gray-900"><?= $utility['catatan']; ?></span>
                        </td>
                        <td rowspan="3">
                            <span class="font-weight-bold text-gray-900">Dibuat Oleh</span>
                            <br>
                            <br>
                            <small class="font-weight-bold text-success"><?= date('d M Y', strtotime($utility['created_at'])); ?></small>
                            <br>
                            <small class="font-weight-bold text-success"><?= date('H : i', strtotime($utility['created_at'])); ?></small>
                            <br>
                            <br>
                            <span class="font-weight-bold text-gray-900"><?= $utility['username']; ?></span>
                        </td>
                        <td rowspan="3">
                            <span class="font-weight-bold text-gray-900">Disetujui Oleh</span>
                            <?php if ($utility['status'] == 'Created' || $utility['status'] == 'Updated') : ?>
                            ...
                            <?php elseif ($utility['status'] == 'Returned' || $utility['status'] == 'Rejected') : ?>
                                <br>
                                <br>
                                <br>
                            ...
                            <?php else : ?>
                                <br>
                                <br>
                                <small class="font-weight-bold text-success"><?= date('d M Y', strtotime($utility['approved_at'])); ?></small>
                                <br>
                                <small class="font-weight-bold text-success"><?= date('H : i', strtotime($utility['approved_at'])); ?></small>
                                <br>
                                <br>
                                <span class="font-weight-bold text-gray-900"><?= $utility2['username']; ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>

                    <td>
                        <p><?= $utility['changecontrol']; ?></p>
                    </td>
                    <!-- <tr>
                            <td>
                                <div class="custom-control custom-radio">
                                    <input type="radio" <?php if ($utility['changecontrol'] == 1) : ?>checked<?php else : ?>disabled<?php endif ?> id="customRadio1" name="customRadio" class="custom-control-input">
                        ...
                        <tr>
                            <td>
                                <div class="custom-control custom-radio">
                                    <input type="radio" <?php if ($utility['changecontrol'] == 0) : ?>checked<?php else : ?>disabled<?php endif ?> id="customRadio2" name="customRadio" class="custom-control-input">
        ...
        <div class="modal-content rounded-md">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/QCP/Approver/Utility/ReturnProject/<?= $utility['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content rounded-md">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/QCP/Approver/Utility/RejectProject/<?= $utility['id']; ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="form-group row mb-0 mt-5">
        ...
        <div class="modal-content rounded-md">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/QCP/Approver/Utility/SaveProject/<?= $utility['id']; ?>" method="post">
                        <?= csrf_field();  ?>
                        <div class="form-group row mb-0 mt-5">
                            <label for="nama" class="col-sm-3 col-form-label">Nama Project </label>
                            <div class="col-sm-9">
                                <textarea readonly rows="4" id="nama" name="nama" class="form-control font-weight-bold text-gray-900 border-0 bg-white"><?= $utility['nama_project']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
                            <label for="nocpr" class="col-sm-3 col-form-label">CPR No. </label>
                            <div class="col-sm-9">
                                <input type="text" id="nocpr" name="nocpr" readonly value="QCP1-<?= $utility['singkatan']; ?>-<?= $utility['cpr_no']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                            </div>
                        </div>
                        <div class="form-group row mb-1">
                            <label for="cc" class="col-sm-4 col-form-label">Change Control </label>
                            <div class="col-sm-8">
                                <?php if (empty($utility['changecontrol'])) : ?>
                                    <input type="text" id="cc" name="cc" value="<?= $utility['changecontrol']; ?>" class="form-control font-weight-bold text-gray-900"></input>
                                <?php else : ?>
                                    <input type="text" id="cc" name="cc" readonly value="<?= $utility['changecontrol']; ?>" class="form-control font-weight-bold text-gray-900 border-0 bg-white"></input>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
