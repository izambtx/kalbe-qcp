...
class UtilityCreator extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('/QCP/Creator/List/Utility', $data);
    }
    ...
    public function detail($id = false)
    {
        ...
        return view('/QCP/Creator/Detail/DetailsUtility', $data);
    }
    ...
    public function create($id = false)
    {
        $data = [
            ...
            'kategori' => $this->kategoriModel->getKategori(),
            'department' => $this->departmentModel->getDepartment(),
            'countCPRno' => $this->utilityModel->getCprNoUtility(),
            'inputFoto' => $this->request->getVar('jumlahFoto')
        ];

        return view('/QCP/Creator/Input/CreateUtility', $data);
    }
    ...
    public function save($id = false)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/QCP/Utility/FormCreate')->withInput()->with('validation', $validation);
        }
        ...
        $id_qcp = $this->utilityModel->getInsertID();
        ...
        return redirect()->to('/QCP/Utility')->with('pesan', 'Project Berhasil Ditambahkan');
    }
    ...
    public function updated()
    {
        ...
        return view('/QCP/Creator/List/UpdatedUtility', $data);
    }

    public function edit($id)
    {
        $data = [
            'title' => 'Edit QCP Utility',
            'kategori' => $this->kategoriModel->getKategori(),
            'department' => $this->departmentModel->getDepartment(),
            'utility' => $this->utilityModel->getUtility($id),
            'inputFoto' => $this->request->getVar('jumlahFoto')
        ];

        return view('/QCP/Creator/Input/EditUtility', $data);
    }
    ...
    public function update($id = false)
    {
        ...
        // CEK TEMA
        $namaLama = $this->utilityModel->getUtility($id);
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/QCP/Utility/FormEdit/' . $id)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/QCP/Utility')->with('pesan', 'Project Berhasil Dirubah');
    }
}
