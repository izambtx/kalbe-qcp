...
class FacilityCreator extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('/QCP/Creator/List/Facility', $data);
    }
    ...
    public function detail($id = false)
    {
        ...
        return view('/QCP/Creator/Detail/DetailsFacility', $data);
    }
    ...
    public function create($id = false)
    {
        $data = [
            ...
            'kategori' => $this->kategoriModel->getKategori(),
            'department' => $this->departmentModel->getDepartment(),
            'countCPRno' => $this->facilityModel->getCprNoFacility(),
            'inputFoto' => $this->request->getVar('jumlahFoto')
        ];

        return view('/QCP/Creator/Input/CreateFacility', $data);
    }
    ...
    public function save($id = false)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/QCP/Facility/FormCreate')->withInput()->with('validation', $validation);
        }
        ...
        $id_qcp = $this->facilityModel->getInsertID();
        ...
        return redirect()->to('/QCP/Facility')->with('pesan', 'Project Berhasil Ditambahkan');
    }
    ...
    public function updated()
    {
        ...
        return view('/QCP/Creator/List/UpdatedFacility', $data);
    }

    public function edit($id)
    {
        $data = [
            'title' => 'Edit QCP Facility',
            'kategori' => $this->kategoriModel->getKategori(),
            'department' => $this->departmentModel->getDepartment(),
            'facility' => $this->facilityModel->getFacility($id),
            'inputFoto' => $this->request->getVar('jumlahFoto')
        ];

        return view('/QCP/Creator/Input/EditFacility', $data);
    }
    ...
    public function update($id = false)
    {
        ...
        // CEK TEMA
        $namaLama = $this->facilityModel->getFacility($id);
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/QCP/Facility/FormEdit/' . $id)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/QCP/Facility')->with('pesan', 'Project Berhasil Dirubah');
    }
}
