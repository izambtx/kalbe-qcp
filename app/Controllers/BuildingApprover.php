...
class BuildingApprover extends BaseController
{
    ...
    public function indexApprover()
    {
        ...
        return view('/QCP/Approver/List/Building', $data);
    }
    ...
    public function detailApprover($id = false)
    {
        ...
        return view('/QCP/Approver/Detail/DetailsBuilding', $data);
    }
    ...
    public function createApprover($id = false)
    {
        ...
        return view('/QCP/Approver/Input/CreateBuilding', $data);
    }
    ...
    public function approve($id = false)
    {
        ...
        return redirect()->to('/QCP/HistoryApprover/Building')->with('pesan', 'Project Berhasil Disetujui');
    }
    ...
    public function return($id = false)
    {
        ...
        return redirect()->to('/QCP/HistoryApprover/Building')->with('pesan', 'Project Berhasil Dikembalikan');
    }
    ...
    public function reject($id = false)
    {
        ...
        return redirect()->to('/QCP/HistoryApprover/Building')->with('pesan', 'Project Berhasil Dibatalkan');
    }

    public function historyBuilding()
    {
        ...
        if ($keyword) {
            ...
            if (in_groups('senior')) {
                ...
                $this->builder->select('qcp.*, distribusi.nama_distribusi, singkatan, users.username, auth_groups_users.group_id');
                $this->builder->join('users', 'users.id = qcp.pembuat');
                $this->builder->join('auth_groups_users', 'auth_groups_users.user_id = users.id');
                $this->builder->join('auth_groups', 'auth_groups.id = auth_groups_users.group_id');
                $this->builder->join('distribusi', 'distribusi.id = qcp.bagian', 'distribusi.id = users.distribusi');
        ...
        $data = [
            'title' => 'List History QCP Building',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
